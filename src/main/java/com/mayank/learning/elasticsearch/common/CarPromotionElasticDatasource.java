...
/*
    File Name : CarPromotionElasticDatasource.java
    
    @author Mayank Sharma
    First Created on 16-10-2020 at 01:21
*/
...
public class CarPromotionElasticDatasource {
    ...
    public void populateData() {
        ...
        CarPromotion promotion6 = new CarPromotion();
        promotion6.setType("discount");
        promotion6.setDescription("Today only! We give 0.5% additional discount");
